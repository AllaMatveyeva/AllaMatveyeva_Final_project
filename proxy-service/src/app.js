...
app.get('/api/characters/:characterId/pic', (req, res) => {
    console.log('Character ID: ' + req.characterId);
    axios.get(`https://the-one-api.dev/v2/character/${req.characterId}`, {
        headers: {
        ...
        .then((client_res) => {
            ...
            crawler.direct({
                ...
                callback: (error, crawler_res) => {
                    ...
                    let pic = jquery("#mw-content-text .mw-parser-output aside figure>a>img");
